    ...
    <div className="flex flex-col w-[90%] sm:w-[325px] h-full bg-card dark:bg-card-dark text-foreground dark:text-foreground-dark p-5 gap-5">
      ...
      <div className=" bg-background dark:bg-background-dark rounded-[8px] flex items-center">
        ...
        <div className="px-5 py-3 text-sm grid grid-cols-2 gap-y-2 font-medium">
          ...
          <p className="text-foreground dark:text-foreground-dark">Apr 14 - May 7</p>

          <div className="flex gap-2 items-center text-description">
            <RiTeamLine size={19} />
            <p>Team:</p>
          </div>
          <div className="flex flex-wrap gap-y-[1px]" style={{ maxWidth: '200px' }}>
        ...
        <div className="w-full mt-auto bg-background dark:bg-background-dark h-[40x] flex items-center px-[4px] overflow-hidden rounded-[8px]">
         ...
         pl-[6px]"
          ...
          <div className="flex ml-auto items-center w-[70px]">
            <Mic className="text-description w-[24px] cursor-pointer" strokeWidth={2.7} />
